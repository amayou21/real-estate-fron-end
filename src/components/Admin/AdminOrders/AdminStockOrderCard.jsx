    ...
    return (
      <Paper className="xl:mx-2 md:mx-2">
        <Grid container className="mb-2">
          ...
          >
            <div>
              <p className="flex justify-center py-2">Stock Title</p>
              <ReactImageGallery
                items={images}
          ...
          <Grid item sm={12} xs={12} lg={9} md={8}>
            ...
            <Link to="/stock/:id" className="flex justify-end px-4 py-2">
...
export default AdminStockOrderCard;
